(function () {
  var STYLES = {
    ...
    "Dark (online)": "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",
  ...
  window._rjAddMapStyleControl = function (map, position) {
    ...
    ctrl.onAdd = function () {
      ...
      div.style.cssText =
        "background:rgba(8,12,20,.85);border:1px solid rgba(100,100,100,.3);border-radius:6px;padding:4px;backdrop-filter:blur(6px)";
      sel = L.DomUtil.create("select", "", div);
      sel.style.cssText =
        "background:transparent;color:#ccc;border:none;font-size:9px;font-family:Courier New,monospace;cursor:pointer;outline:none";
