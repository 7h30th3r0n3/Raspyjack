...
try:
    ...
    _LCD_W = 240 if _DISPLAY_TYPE == "ST7789_240" else (320 if _DISPLAY_TYPE == "CARDPUTER_320" else (264 if _DISPLAY_TYPE == "WAVESHARE_EPD_2IN7" else 128))
    _LCD_H = 240 if _DISPLAY_TYPE == "ST7789_240" else (170 if _DISPLAY_TYPE == "CARDPUTER_320" else (176 if _DISPLAY_TYPE == "WAVESHARE_EPD_2IN7" else 128))
